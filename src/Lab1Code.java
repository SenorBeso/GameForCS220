        ...
        for (int row = 0; row < 10; row++){
            ...
            for (int col = 0; col < 10; col++){
                ...
                if(row > 0 && row < 9 && col >0 && col < 9){
                    sum[row][col] = (matrix[row-1][col-1])+(matrix[row-1][col])+(matrix[row-1][col+1])
                ...
                //top left corner
                if(row==0 && col == 0){
                    sum[row][col] = (matrix[row][col+1])+(matrix[row+1][col])+(matrix[row+1][col+1]);
                }
                //top right corner
                if(row==0 && col == 9){
                    sum[row][col] = (matrix[row][col-1])+(matrix[row+1][col])+(matrix[row+1][col-1]);
                ...
                if (row==0 && (col>0 && col <9 )) {
                    sum[row][col]= (matrix[row][col - 1]) + (matrix[row][col + 1]) +
                        (matrix[row + 1][col - 1]) + (matrix[row + 1][col]) + (matrix[row + 1][col + 1]);
                }
                //bottom row
                ...
                if (col==0 && (row >0 && row < 9)) {
                    sum[row][col] = (matrix[row][col+1])+(matrix[row-1][col])+(matrix[row+1][col])+
